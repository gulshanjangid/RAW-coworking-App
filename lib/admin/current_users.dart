...
class _CurrentUsersState extends State<CurrentUsers> {
  ...
  Future<void> fetchUsers() async {
    final response = await http.get(Uri.parse('https://raw-coworking-app.onrender.com/users'));
  ...
  Future<void> deleteUser(String id) async {
    final response = await http.delete(Uri.parse('https://raw-coworking-app.onrender.com/delete-user/$id'));
          ...
          TextButton(
            onPressed: () async {
              final response = await http.put(
                Uri.parse('https://raw-coworking-app.onrender.com/update-user/${user['_id']}'),
